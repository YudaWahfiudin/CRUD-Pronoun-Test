...
import com.bismillah.pronountest.databinding.ActivityTambahSoalChFourBinding;
...
public class TambahSoalChFourActivity extends AppCompatActivity {

    private static final int REQUEST_CODE_PICK_AUDIO = 1001;

    private ActivityTambahSoalChFourBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityTambahSoalChFourBinding.inflate(getLayoutInflater());
    ...
    private void uploadData() {
        String soalText = binding.inputSoalFour.getText().toString().trim();
        if (soalText.isEmpty()) {
    ...
    private void uploadAudioAndSaveData(String soalText) {
        ...
        storageRef.putFile(selectedAudioUri)
                ...
                .addOnFailureListener(e -> Toast.makeText(TambahSoalChFourActivity.this, "Gagal mengunggah audio", Toast.LENGTH_SHORT).show());
    }

    private void saveDataToDatabase(String soalText, String audioUrl) {
        DatabaseReference databaseRef = FirebaseDatabase.getInstance().getReference().child("soal").child("conversation").child("chapter4").push();
        ...
        databaseRef.setValue(soalData).addOnSuccessListener(aVoid -> {
            Toast.makeText(TambahSoalChFourActivity.this, "Soal berhasil disimpan", Toast.LENGTH_SHORT).show();
            finish();
        }).addOnFailureListener(e -> Toast.makeText(TambahSoalChFourActivity.this, "Gagal menyimpan soal", Toast.LENGTH_SHORT).show());
    }
