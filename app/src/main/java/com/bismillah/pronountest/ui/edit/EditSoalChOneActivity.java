...
import com.bismillah.pronountest.databinding.ActivityEditSoalChOneBinding;
...
public class EditSoalChOneActivity extends AppCompatActivity {

    private static final int REQUEST_CODE_PICK_IMAGE = 1001;
    private static final int REQUEST_CODE_PICK_AUDIO = 1002;

    private ActivityEditSoalChOneBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityEditSoalChOneBinding.inflate(getLayoutInflater());
    ...
    private void uploadImageAndSaveData(String updatedSoalText) {
        if (selectedImageUri != null) {
            ...
            storageRef.putFile(selectedImageUri)
                    ...
                    .addOnFailureListener(e -> Toast.makeText(EditSoalChOneActivity.this, "Gagal mengunggah gambar", Toast.LENGTH_SHORT).show());
        }
    }
    ...
    private void uploadAudioAndSaveData(String updatedSoalText, String imageUrl) {
        if (selectedAudioUri != null) {
            ...
            storageRef.putFile(selectedAudioUri)
                    ...
                    .addOnFailureListener(e -> Toast.makeText(EditSoalChOneActivity.this, "Gagal mengunggah audio", Toast.LENGTH_SHORT).show());
        }
    }
    ...
    private void saveData(String updatedSoalText, String imageUrl, String audioUrl) {
        ...
        databaseRef.updateChildren(soalData).addOnSuccessListener(aVoid -> {
            Toast.makeText(EditSoalChOneActivity.this, "Soal berhasil diperbarui", Toast.LENGTH_SHORT).show();
            finish();
        }).addOnFailureListener(e -> Toast.makeText(EditSoalChOneActivity.this, "Gagal memperbarui soal", Toast.LENGTH_SHORT).show());
    }
