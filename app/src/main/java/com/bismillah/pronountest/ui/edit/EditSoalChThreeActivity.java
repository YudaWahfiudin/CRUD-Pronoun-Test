...
import com.bismillah.pronountest.databinding.ActivityEditSoalChThreeBinding;
...
public class EditSoalChThreeActivity extends AppCompatActivity {

    private static final int REQUEST_CODE_PICK_AUDIO = 1001;

    private ActivityEditSoalChThreeBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityEditSoalChThreeBinding.inflate(getLayoutInflater());
        ...
        binding.buttonUbah.setOnClickListener(v -> {
            ...
            if (!updatedSoalText.isEmpty()) {
                ...
                Toast.makeText(EditSoalChThreeActivity.this, "Soal tidak boleh kosong", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void uploadAudioAndSaveData(String updatedSoalText) {
        ...
        storageRef.putFile(selectedAudioUri)
                ...
                .addOnFailureListener(e -> Toast.makeText(EditSoalChThreeActivity.this, "Gagal mengunggah audio", Toast.LENGTH_SHORT).show());
    }
    ...
    private void saveData(String updatedSoalText, String audioUrl) {
        ...
        databaseRef.updateChildren(soalData).addOnSuccessListener(aVoid -> {
            Toast.makeText(EditSoalChThreeActivity.this, "Soal berhasil diperbarui", Toast.LENGTH_SHORT).show();
            finish();
        }).addOnFailureListener(e -> Toast.makeText(EditSoalChThreeActivity.this, "Gagal memperbarui soal", Toast.LENGTH_SHORT).show());
    }
